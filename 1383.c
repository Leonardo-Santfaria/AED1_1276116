...
Dificuldade : Tive dificuldade para percorrer a matriz verificando cada bloco de 3x3 da mesma e ver se cada número era diferente.
Uso de IA   : Tive auxílio da IA para me explicar o erros da minha lógica no meu códico ao percorrer a matriz por partes individuais de 3x3.
-------------------------------------------------------------------------- */
